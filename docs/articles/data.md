...
```
    ...
    #>   <chr>   <int>        <dbl>
    #> 1 nuts0      32     1.42e-14
    #> 2 nuts1     105     7.11e-15
    #> 3 nuts2     292     7.11e-15
...
#>   <chr>     <int> <dbl>     <dbl>    <dbl>
#> 1 nuts0        52   307       470     26.8
#> 2 nuts1       189  1308       253     15.4
#> 3 nuts2       530  2468       151     12.6
#> 4 nuts3      1711  4788        83     10.8
```
