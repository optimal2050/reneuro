...
- **`ets_cap`** — the EU ETS cap shape: linear reduction at the
  ...
  ETS-covered, so the power cap follows it. Counterintuitively this
  makes the *legislated* path the tightest of the three — the linear
  reduction factors exhaust the cap a decade before the net-zero-2050
  line. Two caveats keep it a shape rather than a hard ceiling:
  allowances bank across years (the annual cap is not an annual
  emissions limit), and the ETS-1 cap covers industry and aviation
  alongside power.
...
- [Understanding the EU
  ETS](https://www.cleanenergywire.org/factsheets/understanding-european-unions-emissions-trading-system)
  — Clean Energy Wire factsheet; under the current linear reduction
  factors the ETS-1 cap reaches zero by 2039.
